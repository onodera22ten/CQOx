...
app.include_router(objective_enhanced_router)
print("[Engine] Registered enhanced objective router at /objective")
...
# Register 3D/4D visualization router
try:
    from backend.engine.router_3d_visualizations import router as viz_3d_router
    app.include_router(viz_3d_router)
    print("[engine] 3D/4D visualization router registered")
except Exception as e:
    print(f"[engine] 3D/4D visualization router disabled: {e}")

# Register Marketing ROI router
try:
    from backend.engine.router_marketing_roi import router as roi_router
    app.include_router(roi_router)
    print("[engine] Marketing ROI router registered")
except Exception as e:
    print(f"[engine] Marketing ROI router disabled: {e}")

# Register DAG visualization router
try:
    from backend.engine.router_dag_visualization import router as dag_router
    app.include_router(dag_router)
    print("[engine] DAG visualization router registered")
except Exception as e:
    print(f"[engine] DAG visualization router disabled: {e}")
